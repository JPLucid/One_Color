...
import kotlinx.android.synthetic.main.level_42.*
...
class Level42 : AppCompatActivity() {
    ...
    val HIGH_SCORE = "high_score_level42"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level42::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level43::class.java)
                startActivity(intent)}
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.level_42)
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_42, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete() {
        ...
        if (win == 2) {
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 42) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_42, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener {
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_42, Gravity.CENTER, 0, 0)
