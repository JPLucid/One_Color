...
import kotlinx.android.synthetic.main.level_8.*
...
class Level8 : AppCompatActivity() {
    ...
    val HIGH_SCORE = "high_score_level8"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level8::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level9::class.java)
                startActivity(intent)}
        }
    }
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_8, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete(){
        ...
        if (bu1.text == "G" && bu2.text == "G" && bu3.text == "G" && bu4.text == "G" &&
                bu6.text == "G" && bu7.text == "G" && bu8.text == "G" && bu9.text == "G"){
            win = 2
        }
        else if (bu1.text == "R" && bu2.text == "R" && bu3.text == "R" && bu4.text == "R" &&
                bu6.text == "R" && bu7.text == "R" && bu8.text == "R" && bu9.text == "R"){
            win = 2
        }
        else if (bu1.text == "Y" && bu2.text == "Y" && bu3.text == "Y" && bu4.text == "Y" &&
                bu6.text == "Y" && bu7.text == "Y" && bu8.text == "Y" && bu9.text == "Y"){
            win = 2
        }
        if (win==2){
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 8) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_8, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener{
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_8, Gravity.CENTER, 0, 0)
