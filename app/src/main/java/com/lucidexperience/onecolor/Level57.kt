...
import kotlinx.android.synthetic.main.level_57.*
import kotlinx.android.synthetic.main.next_popup.*
import java.util.*


class Level57 : AppCompatActivity() {

    var move_count = 0
    val myPreferences = "myPrefs"
    val HIGH_SCORE = "high_score_level57"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level57::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level58::class.java)
                startActivity(intent)}
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.level_57)
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_57, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete(){
        ...
        if (bu1.text == "G" && bu2.text == "G" && bu3.text == "G" && bu4.text == "G" &&
                ...
                bu9.text == "G" && bu10.text == "G" && bu11.text == "G" && bu12.text == "G" &&
                bu13.text == "G" && bu14.text == "G" && bu15.text == "G" && bu16.text == "G" &&
                bu17.text == "G" && bu18.text == "G" && bu19.text == "G" && bu20.text == "G" &&
            ...
            win = 2
                ...
                bu9.text == "R" && bu10.text == "R" && bu11.text == "R" && bu12.text == "R" &&
                bu13.text == "R" && bu14.text == "R" && bu15.text == "R" && bu16.text == "R" &&
                bu17.text == "R" && bu18.text == "R" && bu19.text == "R" && bu20.text == "R" &&
            ...
            win = 2
                ...
                bu9.text == "Y" && bu10.text == "Y" && bu11.text == "Y" && bu12.text == "Y" &&
                bu13.text == "Y" && bu14.text == "Y" && bu15.text == "Y" && bu16.text == "Y" &&
                bu17.text == "Y" && bu18.text == "Y" && bu19.text == "Y" && bu20.text == "Y" &&
        ...
        if (win==2){
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 57) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_57, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener{
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_57, Gravity.CENTER, 0, 0)
