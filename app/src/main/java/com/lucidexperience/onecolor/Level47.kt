...
import kotlinx.android.synthetic.main.level_47.*
import kotlinx.android.synthetic.main.next_popup.*
import java.util.*

class Level47 : AppCompatActivity() {

    var move_count = 0
    val myPreferences = "myPrefs"
    val HIGH_SCORE = "high_score_level47"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level47::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level48::class.java)
                startActivity(intent)}
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.level_47)
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_47, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete() {
        var win = 1
        if (bu3.text == "G" && bu7.text == "G" && bu8.text == "G" && bu9.text == "G" &&
                bu11.text == "G" && bu12.text == "G" && bu13.text == "G" && bu14.text == "G" &&
                bu15.text == "G" && bu17.text == "G" && bu18.text == "G" && bu19.text == "G" &&
                bu23.text == "G"){
            win = 2
        }
        else if (bu3.text == "R" && bu7.text == "R" && bu8.text == "R" && bu9.text == "R" &&
                bu11.text == "R" && bu12.text == "R" && bu13.text == "R" && bu14.text == "R" &&
                bu15.text == "R" && bu17.text == "R" && bu18.text == "R" && bu19.text == "R" &&
                bu23.text == "R"){
            win = 2
        }
        else if (bu3.text == "Y" && bu7.text == "Y" && bu8.text == "Y" && bu9.text == "Y" &&
                bu11.text == "Y" && bu12.text == "Y" && bu13.text == "Y" && bu14.text == "Y" &&
                bu15.text == "Y" && bu17.text == "Y" && bu18.text == "Y" && bu19.text == "Y" &&
                bu23.text == "Y"){
            win = 2
        }
        if (win == 2) {
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 47) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_47, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener {
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_47, Gravity.CENTER, 0, 0)
