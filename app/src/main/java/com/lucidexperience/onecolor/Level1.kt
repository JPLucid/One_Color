...
class Level1 : AppCompatActivity() {
    ...
    val HIGH_SCORE = "high_score_level1"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            replay_btn -> {val intent = Intent(this, Level1::class.java)
                startActivity(intent)}
            retry_btn -> {val intent = Intent(this, Level1::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            level_select_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level2::class.java)
                startActivity(intent)}
        }
    }
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_1, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete(){
        var win = 1
        if (bu1.text == "G" && bu3.text == "G" && bu4.text == "G" && bu5.text == "G" &&
                bu6.text == "G" && bu7.text == "G" && bu9.text == "G"){
            win = 2
        }
        else if (bu1.text == "R" && bu3.text == "R" && bu4.text == "R" && bu5.text == "R" &&
                bu6.text == "R" && bu7.text == "R" && bu9.text == "R"){
            win = 2
        }
        else if (bu1.text == "Y" && bu3.text == "Y" && bu4.text == "Y" && bu5.text == "Y" &&
                bu6.text == "Y" && bu7.text == "Y" && bu9.text == "Y"){
            win = 2
        }
        if (win==2){
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 1) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_1, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener{
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_1, Gravity.CENTER, 0, 0)
