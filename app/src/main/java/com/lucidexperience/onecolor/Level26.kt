...
import kotlinx.android.synthetic.main.level_26.*
...
class Level26 : AppCompatActivity() {
    ...
    val HIGH_SCORE = "high_score_level26"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level26::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level27::class.java)
                startActivity(intent)}
        }
    }
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_26, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete() {
        var win = 1
        if (bu2.text == "G" && bu6.text == "G" && bu7.text == "G" && bu8.text == "G" &&
                bu9.text == "G" && bu10.text == "G" && bu11.text == "G" && bu15.text == "G"){
            win = 2
        }
        else if (bu2.text == "R" && bu6.text == "R" && bu7.text == "R" && bu8.text == "R" &&
                bu9.text == "R" && bu10.text == "R" && bu11.text == "R" && bu15.text == "R"){
            win = 2
        }
        else if (bu2.text == "Y" && bu6.text == "Y" && bu7.text == "Y" && bu8.text == "Y" &&
                bu9.text == "Y" && bu10.text == "Y" && bu11.text == "Y" && bu15.text == "Y"){
            win = 2
        }
        if (win == 2) {
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 26) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_26, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener {
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_26, Gravity.CENTER, 0, 0)
