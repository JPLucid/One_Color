...
import kotlinx.android.synthetic.main.level_44.*
...
class Level44 : AppCompatActivity() {
    ...
    val HIGH_SCORE = "high_score_level44"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level44::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level45::class.java)
                startActivity(intent)}
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.level_44)
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_44, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete() {
        var win = 1
        if (bu2.text == "G" && bu3.text == "G" && bu4.text == "G" && bu6.text == "G" &&
                bu8.text == "G" && bu10.text == "G" && bu11.text == "G" && bu12.text == "G" &&
                bu13.text == "G" && bu14.text == "G" && bu15.text == "G" && bu16.text == "G" &&
                bu18.text == "G" && bu20.text == "G" && bu22.text == "G" && bu23.text == "G" &&
                bu24.text == "G") {
            win = 2
        } else if (bu2.text == "R" && bu3.text == "R" && bu4.text == "R" && bu6.text == "R" &&
                bu8.text == "R" && bu10.text == "R" && bu11.text == "R" && bu12.text == "R" &&
                bu13.text == "R" && bu14.text == "R" && bu15.text == "R" && bu16.text == "R" &&
                bu18.text == "R" && bu20.text == "R" && bu22.text == "R" && bu23.text == "R" &&
                bu24.text == "R") {
            win = 2
        } else if (bu2.text == "Y" && bu3.text == "Y" && bu4.text == "Y" && bu6.text == "Y" &&
                bu8.text == "Y" && bu10.text == "Y" && bu11.text == "Y" && bu12.text == "Y" &&
                bu13.text == "Y" && bu14.text == "Y" && bu15.text == "Y" && bu16.text == "Y" &&
                bu18.text == "Y" && bu20.text == "Y" && bu22.text == "Y" && bu23.text == "Y" &&
                bu24.text == "Y") {
            win = 2
        }
        if (win == 2) {
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 44) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_44, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener {
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_44, Gravity.CENTER, 0, 0)
