...
import kotlinx.android.synthetic.main.level_40.*
import kotlinx.android.synthetic.main.next_popup.*
import java.util.*

class Level40 : AppCompatActivity() {

    var move_count = 0
    val myPreferences = "myPrefs"
    val HIGH_SCORE = "high_score_level40"
    var high_score = "--"
    ...
    fun winnerSelect(v: View){
        ...
        when(winnerBu) {
            retry_btn -> {val intent = Intent(this, Level40::class.java)
                startActivity(intent)}
            back_btn -> {val intent = Intent(this, LevelScreen::class.java)
                startActivity(intent)}
            next_level_btn -> {val intent = Intent(this, Level41::class.java)
                startActivity(intent)}
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.level_40)
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.credits -> {
                        ...
                        creditsPopup.showAtLocation(level_40, Gravity.CENTER, 0, 0)
                        true
                    }
                    else -> false
                }
    ...
    private fun checkComplete() {
        ...
        if (win == 2) {
            ...
            if (sharedPreferences!!.getInt(levelLockState, level_lock_initial) <= 40) {
                val editor = sharedPreferences!!.edit()
            ...
            // Finally, show the popup window on app
            winnerPopup.showAtLocation(level_40, Gravity.CENTER, 0, 0)
            ...
            winnerPopup.setOnDismissListener {
                ...
                // Finally, show the popup window on app
                nextPopup.showAtLocation(level_40, Gravity.CENTER, 0, 0)
